...
public class GomokuRules implements GameRules {
  ...
  public GomokuRules() {
    this.configRules = new HashMap<String, ConfigRule>();
    this.stoneRules = new HashMap<String, StoneRule>();
    this.endGameRules = new HashMap<String, EndGameRule>();
    ...
    this.endGameRules.put("isAlligmentWin", new GomokuFiveInARowUnbreakableRule());
